export const translations = {
  en: {
    ...
    amrEradDesc: "Oxford High-Tech Research Institute developed SN Water (Strongly Acidic Ionized Water) that eliminates MRSA (Methicillin-Resistant Staphylococcus aureus)—responsible for over 72% of all AMR deaths—in just 15 to 120 seconds. Intentionally kept unpatented as a proprietary trade secret (Coca-Cola formula model) to safeguard its quantum formula.",
  ...
  jp: {
    ...
    amrEradDesc: "当研究所が開発した強酸性イオン水『SN水』は、耐性菌死亡原因の72%以上を占めるMRSAをわずか15秒〜120秒で検出限界未満へ完全死滅させます。量子フォーミュラ保護のため、特許化せずノウハウ秘匿（コカ・コーラ方式）として厳重管理されています。",
  ...
  kr: {
    ...
    amrEradDesc: "당 연구소가 개발한 강산성 이온수 'SN Water'는 내성균 사망 원인의 72% 이상을 차지하는 MRSA(메티실린 내성 황색포도상구균)를 단 15초~120초 만에 검출 한계 미만으로 100% 완전 사멸시킵니다. 양자 포뮬러의 영구적 보호를 위해 특허 출원 대신 코카콜라 방식의 노하우 비닉(Trade Secret)으로 엄격히 관리됩니다.",
